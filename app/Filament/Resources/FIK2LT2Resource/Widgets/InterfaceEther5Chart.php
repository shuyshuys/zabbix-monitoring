...
{
    protected static ?string $heading = 'Interface Ether5 (R.108) Traffic';
    ...
    protected function getData(): array
    {
        ...
        return $zabbix->getInterfaceTraffic($hostName, $this->filter, 'ether5_R.108');
    }

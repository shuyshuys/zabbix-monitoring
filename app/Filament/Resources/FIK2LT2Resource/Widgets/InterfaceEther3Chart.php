...
{
    protected static ?string $heading = 'Interface Ether3 (Lab Solusi) Traffic';
    ...
    protected function getData(): array
    {
        ...
        return $zabbix->getInterfaceTraffic($hostName, $this->filter, 'ether3_Lab_SOLUSI');
    }

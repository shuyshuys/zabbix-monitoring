...
{
    protected static ?string $heading = 'Interface Ether4 (Server Solusi) Traffic';
    ...
    protected function getData(): array
    {
        ...
        return $zabbix->getInterfaceTraffic($hostName, $this->filter, 'ether4_Server');
    }

...
{
    protected static ?string $heading = 'Interface Ether3 (LT3) Traffic';
    ...
    protected function getData(): array
    {
        ...
        return $zabbix->getInterfaceTraffic($hostName, $this->filter, 'ether3');
    }
    ...
    {
        return 'Ether3 (LT2) Traffic Chart';
    }

...
{
    protected static ?string $heading = 'Interface Ether5 (LT 6) Traffic';
    ...
    protected function getData(): array
    {
        ...
        foreach ($items as $item) {
            if (isset($item['name'])) {
                if (str_contains($item['name'], 'Interface ether5(): Bits sent')) {
                    $targetItems['Bits sent'] = $item;
                } elseif (str_contains($item['name'], 'Interface ether5(): Bits received')) {

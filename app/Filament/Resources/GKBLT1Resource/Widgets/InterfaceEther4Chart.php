...
{
    protected static ?string $heading = 'Interface Ether4 (LT 4) Traffic';
    ...
    protected function getData(): array
    {
        ...
        foreach ($items as $item) {
            if (isset($item['name'])) {
                if (str_contains($item['name'], 'Interface ether4(): Bits sent')) {
                    $targetItems['Bits sent'] = $item;
                } elseif (str_contains($item['name'], 'Interface ether4(): Bits received')) {

...
{
    protected static ?string $heading = 'Interface Ether6 (LT 6) Traffic';
    ...
    protected function getData(): array
    {
        ...
        foreach ($items as $item) {
            if (isset($item['name'])) {
                if (str_contains($item['name'], 'Interface ether6(): Bits sent')) {
                    $targetItems['Bits sent'] = $item;
                } elseif (str_contains($item['name'], 'Interface ether6(): Bits received')) {

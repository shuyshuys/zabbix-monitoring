...
{
    protected static ?string $heading = 'Interface Ether1 (LT 1) Traffic';
    ...
    protected function getData(): array
    {
        ...
        foreach ($items as $item) {
            if (isset($item['name'])) {
                if (str_contains($item['name'], 'Interface ether1(): Bits sent')) {
                    $targetItems['Bits sent'] = $item;
                } elseif (str_contains($item['name'], 'Interface ether1(): Bits received')) {

...
class InterfaceEther8Chart extends ChartWidget
{
    protected static ?string $heading = 'Interface Ether8 Traffic';
    ...
    protected function getData(): array
    {
        ...
        foreach ($items as $item) {
            if (isset($item['name'])) {
                if (str_contains($item['name'], 'Interface ether8(): Bits sent')) {
                    $targetItems['Bits sent'] = $item;
                } elseif (str_contains($item['name'], 'Interface ether8(): Bits received')) {

...
{
    protected static string $view = 'filament.resources.g-k-b-l-t2-resource.widgets.traceroute-widget';    // protected static string $view = 'filament.widgets.traceroute-widget';
    ...
    {
        $target = '192.166.7.210'; // Ganti dengan IP tujuan traceroute Anda
